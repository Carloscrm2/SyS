  ...
  % * Graficas de señles reales y complejas continuas
  % * Transformacion de señales continuas (escalamientos y traslaciones)
  ...
  % <https://maslinux.es/3-alternativas-de-codigo-abierto-a-matlab/> 
  %
  %
  %
  %
...
%definimos la funcionn escalon unitario:
  u = @(t) t>=0;
...
%%  
%*M1.4 Integracion y estimacion de la energia de una se�al*
%considera la se�al x(t) = e^t(u(t)  u(t<1))
%la energia de la se�al x(t) se expresa como 
%Ex = Integral [-inf, inf] |x(t)|2 dt = intgerla [-inf, in] e^2t dt.
